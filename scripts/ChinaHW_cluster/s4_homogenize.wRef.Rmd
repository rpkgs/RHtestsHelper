...
all.equal(as.character(sites), names(lst))

f_mon = glue("./OUTPUT/ChinaHI/RHtests_RH_avg_monthly_v20230227.RDS")
res2 <- readRDS(f_mon)
...
st_refs <- st_refer(st, mat_mon, nsite = NULL)
...
```{r}
# InitCluster(10)
file_RHtests_daily_withRef = "./OUTPUT/ChinaHI/RHtests_daily_withRef_v20230227.RDS"
